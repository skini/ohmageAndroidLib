...
public class NotifEditActivity extends ListActivity implements OnClickListener {
    ...
    private void setupListAdaptor() {
        ...
        mListAdapter = new ArrayAdapter<Integer>(this, R.id.repeat_list_text, mListData) {
            ...
            private View getTwoLineView(LayoutInflater inflater, int pos) {
                View view = inflater.inflate(R.layout.trigger_two_line_list_item, null);
            ...
            private View getRepeatHeaderView(LayoutInflater inflater, int pos) {
                ...
                boolean enable = true;
                if ((mListData.get(LIST_POS_DURATION) - 1) < mNotifDesc.getMinAllowedRepeat()) {
            ...
            private View getRepeatItemView(LayoutInflater inflater, int pos) {
                View view = inflater.inflate(R.layout.trigger_notif_edit_repeat_row, null);

                ImageButton ib = (ImageButton) view.findViewById(R.id.button_remove_repeat);

                ib.setFocusable(false);
                ib.setTag(new Integer(pos));
                ib.setOnClickListener(NotifEditActivity.this);

                TextView tv = (TextView) view.findViewById(R.id.repeat_list_text);
