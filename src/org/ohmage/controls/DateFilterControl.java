...
public class DateFilterControl extends LinearLayout {
    ...
    // e.g. 6 ends up being 13 items total: 6 months before, the current month,
    // and 6 months after
    private final int PICKER_RANGE = 3;
    // determines the unit that the filter pages through; the date string
    // formatter is set accordingly
    ...
    protected void initControl(Context context) {
        ...
        // make a simple date formatter to display the thing (this may change
    ...
    /**
     * Gets the displayed text for the currently selected item (i.e. the text
    ...
    /**
     * Gets the defined value for the currently selected item (i.e. the actual
     * Calendar object)
     * 
    ...
    /**
     * Attaches a {@link DateFilterChangeListener} to the filter which will be
     * called when the user navigates between items.
     * 
     * @param listener an object implementing {@link DateFilterChangeListener}
     *            which will be called when the list index is changed.
     */
    ...
    private class FilterClickHandler implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (id == R.id.controls_filter_prev) {
                ...
                // the dialog changes with the current selection, so update it
