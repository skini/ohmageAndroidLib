...
public class ProfileActivity extends BaseInfoActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // make the background of the profile striped to indicate it's not used
        // yet
        setContentView(R.layout.profile_layout);

        // set up some generic stuff for the profile, since it's not databound
        // in any respect
        mContext = this;
        ...
        OnClickListener profileActionListener = new OnClickListener() {
            ...
            public void onClick(View v) {
                Analytics.widget(v);
                int id = v.getId();
                if (id == R.id.profile_info_button_logout_wipe) {
                    mAccountHelper.logout();
                } else if (id == R.id.profile_info_button_update_password) {
